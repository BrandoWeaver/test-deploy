<template>
  <div class="w-full bg-white md-max:pb-[28px] relative">
    <!-- Outer Container for Centered Header -->
    <div class="w-full mx-auto md-max:px-[16px]">
      <!-- Section Header -->
      <div class="flex justify-between items-center mb-4">
        <h2
          class="font-bold text-[17px] md-max:leading-[30.6px] text-black border-b border-transparent hover:border-black transition-all duration-300 leading-[25px] py-[4px]"
        >
          From this series
        </h2>
      </div>
    ...
    <div class="relative w-full">
      ...
      <button
        @click="scrollLeft"
        class="absolute top-1/2 left-0 z-10 -translate-y-1/2 bg-[#eff1d9] shadow-md rounded-full w-[28px] h-[28px] flex items-center justify-center hover:scale-110 transition"
      ...
      <div
        ref="carousel"
        class="relative w-full md-max:h-auto flex overflow-x-auto no-scrollbar gap-[10px] md-max:gap-[8px] md-max:px-[16px]"
      ...
      >
        <div
          ...
          :key="index"
          class="flex group md-max:flex-shrink-0 flex-col justify-between md-max:w-[186px] xs:h-full bg-[#F5F5F5] rounded-lg p-1"
        >
          <!-- Top Section -->
          <div
            class="flex-shrink flex-col gap-[4px] md:gap-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          >
            <!-- AI Label and Title -->
            <div class="flex items-center gap-[2px]">
              <!-- AI Label -->
              <div
                class="flex items-center px-2 py-1 lg:px-[2px] lg:py-[4px] md:px-[2px] md:py-[4px] sm:px-[2px] sm:py-[6px] xs:px-[2px] xs:py-[6px] bg-[rgba(0,0,0,0.5)] text-white rounded-[2px]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="11"
              ...
              <!-- Title -->
              <span
                class="px-2 py-1 lg:px-[2px] lg:py-[3px] md:px-[2px] md:py-[3px] text-[8px] md:text-[10px] sm:text-[10px] sm:px-[2px] sm:py-[4px] xs:text-[10px] xs:px-[2px] xs:py-[4px] font-bold text-white bg-[rgba(0,0,0,0.5)] rounded-[2px]"
              >
                Title (Pineapple)
              </span>
            </div>
            ...
            <!-- Author Label -->
            <span
              class="px-2 py-1 lg:px-[2px] lg:py-[3px] lg:leading-[14.4px] md:px-[2px] md:py-[3px] sm:px-[3px] sm:py-[6px] sm:leading-[14.4px] xs:px-[3px] xs:py-[6px] xs:leading-[14.4px] md:leading-[14.4px] text-[8px] font-normal text-white bg-[rgba(0,0,0,0.5)] rounded-[2px]"
            >
              By Ch. Ratana
            </span>
          </div>
          <div class="mx-auto pl-4">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1824_69054)">
                <path
                  d="M63.8333 0.34375H17.1667C12.748 0.349043 8.51186 2.10669 5.3874 5.23115C2.26294 8.35561 0.505293 12.5918 0.5 17.0104L0.5 63.6771C0.505293 68.0957 2.26294 72.3319 5.3874 75.4564C8.51186 78.5808 12.748 80.3385 17.1667 80.3438H63.8333C68.252 80.3385 72.4881 78.5808 75.6126 75.4564C78.7371 72.3319 80.4947 68.0957 80.5 63.6771V17.0104C80.4947 12.5918 78.7371 8.35561 75.6126 5.23115C72.4881 2.10669 68.252 0.349043 63.8333 0.34375V0.34375ZM17.1667 7.01042H63.8333C66.4855 7.01042 69.029 8.06399 70.9044 9.93935C72.7798 11.8147 73.8333 14.3583 73.8333 17.0104V63.6771C73.8276 65.162 73.4857 66.6264 72.8333 67.9604L42.29 37.4171C40.7423 35.869 38.9048 34.6409 36.8824 33.8031C34.86 32.9652 32.6924 32.534 30.5033 32.534C28.3143 32.534 26.1466 32.9652 24.1243 33.8031C22.1019 34.6409 20.2644 35.869 18.7167 37.4171L7.16667 48.9637V17.0104C7.16667 14.3583 8.22024 11.8147 10.0956 9.93935C11.971 8.06399 14.5145 7.01042 17.1667 7.01042ZM17.1667 73.6771C14.5145 73.6771 11.971 72.6235 10.0956 70.7482C8.22024 68.8728 7.16667 66.3292 7.16667 63.6771V58.3904L23.4267 42.1304C24.3553 41.2012 25.458 40.464 26.6717 39.961C27.8854 39.4581 29.1862 39.1992 30.5 39.1992C31.8138 39.1992 33.1146 39.4581 34.3283 39.961C35.542 40.464 36.6447 41.2012 37.5733 42.1304L68.1167 72.6771C66.7827 73.3295 65.3183 73.6713 63.8333 73.6771H17.1667Z"
                  fill="black"
                  fill-opacity="0.1"
                />
                <path
                  d="M53.8337 35.3431C56.1411 35.3431 58.3967 34.6589 60.3153 33.3769C62.2339 32.095 63.7292 30.2729 64.6123 28.1411C65.4953 26.0093 65.7263 23.6635 65.2762 21.4004C64.826 19.1373 63.7149 17.0585 62.0832 15.4269C60.4516 13.7952 58.3728 12.6841 56.1097 12.2339C53.8466 11.7838 51.5008 12.0148 49.369 12.8978C47.2372 13.7809 45.4151 15.2762 44.1332 17.1948C42.8512 19.1134 42.167 21.369 42.167 23.6764C42.167 26.7706 43.3962 29.7381 45.5841 31.926C47.772 34.1139 50.7395 35.3431 53.8337 35.3431ZM53.8337 18.6764C54.8226 18.6764 55.7893 18.9697 56.6115 19.5191C57.4338 20.0685 58.0746 20.8494 58.4531 21.763C58.8315 22.6767 58.9305 23.682 58.7376 24.6519C58.5447 25.6218 58.0685 26.5127 57.3692 27.212C56.6699 27.9112 55.779 28.3874 54.8091 28.5804C53.8392 28.7733 52.8339 28.6743 51.9202 28.2958C51.0066 27.9174 50.2257 27.2765 49.6763 26.4543C49.1269 25.632 48.8337 24.6653 48.8337 23.6764C48.8337 22.3504 49.3604 21.0786 50.2981 20.1409C51.2358 19.2032 52.5076 18.6764 53.8337 18.6764Z"
                  fill="black"
                  fill-opacity="0.1"
                />
              </g>
              <defs>
                <clipPath id="clip0_1824_69054">
                  <rect
                    width="80"
                    height="80"
                    fill="white"
          ...
          <!-- Bottom Section -->
          <div
            class="flex justify-between items-end opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          >
            <!-- Left: Time -->
            <div class="flex items-center gap-[2px]">
              <!-- Mute Icon -->
              <div
                class="flex h-[19px] md:h-[24px] items-center px-[4px] py-[3px] md:px-[6px] md:py-[8px] bg-[rgba(0,0,0,0.5)] rounded"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-[12px] h-[12px] md:w-[14px] md:h-[14px] sm:w-[12px] sm:h-[12px] xs:w-[12px] xs:h-[12px]"
                  viewBox="0 0 9 9"
                  fill="none"
                >
              ...
              <!-- Duration -->
              <span
                class="px-[4px] py-[2px] md:px-[6px] md:py-[5px] text-[10px] text-white bg-[rgba(0,0,0,0.5)] rounded"
              >
                04:33
              </span>
            </div>
            ...
            <div
              class="flex flex-col justify-end items-end gap-2 lg:gap-[2px] md:gap-[2px] sm:gap-[2px] xs:gap-[2px]"
            >
              <!-- Price Section -->
              <div
              ...
              >
                <div
                  class="line-through text-[8px] lg:text-[10px] md:text-[10px] sm:text-[10px] xs:text-[10px] text-white/70"
                >
                  $35
                </div>
                <div
                  class="font-bold lg:text-[14px] md:text-[14px] sm:text-[14px] xs:text-[14px] text-[12px]"
                >
                  $35
                </div>
              </div>
              ...
              <!-- Action Buttons -->
              <div class="flex h-[19px] md:h-[24px] gap-[2px]">
                <button
                  class="px-[4px] py-[3px] md:px-[6px] md:py-[8px] bg-[rgba(0,0,0,0.5)] rounded-md flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[12px] h-[12px] md:w-[14px] md:h-[14px] sm:w-[12px] sm:h-[12px] xs:w-[12px] xs:h-[12px]"
                ...
                <button
                  class="px-[4px] py-[3px] bg-[rgba(0,0,0,0.5)] rounded-md flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[12px] h-[12px] md:w-[14px] md:h-[14px] sm:w-[12px] sm:h-[12px] xs:w-[12px] xs:h-[12px]"
                ...
                <button
                  class="sm-max:hidden px-[4px] py-[3px] bg-[rgba(0,0,0,0.5)] rounded-md flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[12px] h-[12px] md:w-[14px] md:h-[14px] sm:w-[12px] sm:h-[12px] xs:w-[12px] xs:h-[12px]"
      ...
      <button
        @click="scrollRight"
        class="absolute top-1/2 right-0 -translate-y-1/2 z-10 bg-[#eff1d9] shadow-md rounded-full w-[28px] h-[28px] flex items-center justify-center hover:scale-110 transition"
        v-if="isCarouselHovered"
      >
        <svg
          width="9"
...
export default {
  ...
  data() {
    return {
      items: Array(8).fill({
        image: null, // Replace with actual image URLs if available
      }),
      isCarouselHovered: false, // Tracks hover state of the Cards Carousel
    }
  },
  methods: {
    scrollLeft() {
    ...
    handleCarouselHover(state) {
      this.isCarouselHovered = state
    },
  },
}
</script>
