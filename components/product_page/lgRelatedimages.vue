<template>
  <div class="w-full mx-auto bg-white pb-8 relative">
    ...
    <div class="relative w-full">
      ...
      <div
        ref="carousel"
        class="relative w-full flex overflow-x-auto no-scrollbar gap-4 md-max:gap-[8px] md-max:px-[16px]"
        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-[2px]">
              ...
              <!-- Title -->
              <span
                class="px-2 py-1 lg:px-[2px] lg:py-[3px] md:px-[2px] md:py-[3px] text-[8px] md:text-[10px] sm:text-[10px] sm:px-[2px] sm:py-[4px] font-bold text-white bg-[rgba(0,0,0,0.5)] rounded-[2px]"
              >
                Title (Pineapple)
              </span>
            </div>
            ...
            <!-- Author Label -->
            <span
              class="px-2 py-1 lg:px-[2px] lg:py-[3px] lg:leading-[14.4px] md:px-[2px] md:py-[3px] md:leading-[14.4px] sm:px-[3px] sm:py-[6px] sm:leading-[14.4px] xs:px-[3px] xs:py-[6px] xs:leading-[14.4px] text-[8px] font-normal text-white bg-[rgba(0,0,0,0.5)] rounded-[2px]"
            >
              By Ch. Ratana
            </span>
          </div>
