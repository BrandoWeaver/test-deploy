<template>
  <!-- Main Container -->
  <div
    class="h-auto flex flex-col rounded-lg bg-[#EFF1D9] pb-[18px] relative w-full mt-8"
  >
    <div
      class="px-6 xl-max:w-full pt-[16px] md-max:pt-[6px] lg-max:w-full mx-auto gap-6 w-[1440px]"
    >
    ...
    <div
      ref="carousel"
      class="w-full flex justify-center overflow-y-hidden no-scrollbar gap-4 relative py-4"
    >
      <div
        v-for="(product, index) in filteredProducts"
        :key="index"
        class="product-card w-[300.6px] p-[18px] h-full bg-white shadow-md flex-shrink-0 flex flex-col items-start gap-2 rounded-[7px]"
      >
        <!-- Product Image -->
        <div
        ...
        <div class="flex gap-2 w-full">
          ...
          <button
            class="w-[234px] flex items-center justify-center gap-[6px] text-black text-sm border border-[rgba(0,0,0,0.5)] rounded-lg hover:border-black"
          >
            <!-- SVG Icon -->
            <svg
              width="14"
