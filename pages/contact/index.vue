<template>
  ...
  <!-- <HaveQuestions /> -->
  <NeedHelpCom
    top-title="Have More Questions?"
    link="Ask us your question"
    des="If you have a question that wasn’t answered in our FAQ, don’t hesitate to reach out to us. We’re here to help! Simply fill out the form below, and our support team will get back to you as soon as possible."
    :rotate="-90"
  />
</template>

<script setup>
import GetInTouch from '@/components/all-proCom/GetInTouch.vue'
import ContactForm from '@/components/all-proCom/ContactForm.vue'
import FAQShort from '~/components/HomeCom/FAQShort.vue'
import Footer from '@/components/all-proCom/Footer.vue'
import Navbar from '@/components/all-proCom/Navbar.vue'
import HaveQuestions from '@/components/all-proCom/HaveQuestions.vue'
import QuickAnswer from '~/components/quickAnswerCom/QuickAnswer.vue'
import NeedHelpCom from '~/components/all-proCom/NeedHelpCom.vue'
