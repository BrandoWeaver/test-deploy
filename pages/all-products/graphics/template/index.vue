<template>
    ...
    <div class="text-[#1C1C1C] w-[1440px] xl-max:w-full pt-[16px] md-max:pt-[6px] mb-10 md-max:w-full mx-auto gap-6 px-6 md-max:px-[16px] font-noto">
        <div class="menu text-[11px] mt-10 flex gap-3 text-black/50 py-6">
            <NuxtLink to="/" class="hover:text-[#005B52]">Home</NuxtLink> / 
            <NuxtLink to="/all-products" class="hover:text-[#005B52]">All Products</NuxtLink> / 
            <NuxtLink to="/all-products/graphics" class="hover:text-[#005B52]">Graphics</NuxtLink> /
            <NuxtLink to="/all-products/graphics/template" class="text-black hover:text-[#005B52]">Template</NuxtLink>
        </div>
        
        <h1 class="font-[700] heading text-[22px] sm:text-[26px]">
            Accelerate Your Workflow with Ready-to-Use Templates
        </h1>

        <p class="text-[15px] my-3 font-light">
          The Templates section of Thortok offers a curated selection of professionally designed layouts to help you create polished visuals faster. Unlike individual components, templates provide structured, ready-to-edit compositions—ideal for social media posts, business presentations, e-commerce pages, portfolios, and more.
        </p>

        <p class="text-[15px] my-3 font-light mt-10">
          Whether you’re a designer, marketer, entrepreneur, or freelancer, our templates are crafted to save you time while maintaining full creative flexibility. Each file is easy to customize, letting you adapt colors, text, and structure to fit your branding or campaign goals.
        </p>

        <div class="flex gap-6 py-6">
          <div class="w-[50%]">
            <p class="text-[15px] font-light">
              To make browsing easier and more intuitive, we’ve structured the Templates section into well-defined categories so users can quickly find templates that match their creative needs:
            </p>

            <div class="my-6">
              <div class="grid grid-cols-2 text-[13px] gap-4 my-4">
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">Social Media</button>
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">Marketing</button>
              </div>
              <div class="grid grid-cols-2 text-[13px] gap-4 my-4">
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">Business & Branding</button>
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">Presentation</button>
              </div>
              <div class="grid grid-cols-2 text-[13px] gap-4 my-4">
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">Resume & Portfolio</button>
                <button class="px-3 py-2 rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">e-Commerce</button>
              </div>
              <button class="px-3 py-2 text-[13px] rounded-md text-[#1C1C1C] bg-[#F5F5F5] border w-full">UX/UI Design</button>
            </div>
             <p class="text-[15px] my-3 font-light">
              Each category includes editable files in various formats—such as AI, EPS, PSD, and SVG—to meet the specific needs of different design sectors and tools.
             </p>

          </div>
          
          <div class="w-[50%]">
            <img src="/images/graphics/templates/img_bg.png" alt="thortok" />
          </div>
        </div>
    </div>

    <DiscoverOurLatestAdditions
        titleHeader="Discover our latest additions"
        :menuList="menuList"
    ...
    <QuickAnswer :top-title="'Quick Answers to Your Questions'" :tabs="tabs" />
...
<script setup>
    ...
    import QuickAnswer from '~/components/quickAnswerCom/QuickAnswer.vue'
    import WhyChooseUs from '~/components/all-proCom/WhyChooseUs.vue'
    import DiscoverOurLatestAdditions from '~/components/all-proCom/DiscoverOurLatestAdditions.vue'
    ...
    const tabContentList = ref([
        {
            ...
            menu_id: 1,
            name: "Sample Tab 1",
            thumbnail: "https://s3.eu-central-003.backblazeb2.com/thortok-bucket/graphics/2025/05/1747649862.webp",
            link: ""
        },
        {
            id: 1,
