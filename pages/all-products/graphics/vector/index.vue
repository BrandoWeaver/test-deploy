<template>
    ...
    <div class="text-[#1C1C1C] w-[1440px] xl-max:w-full pt-[16px] md-max:pt-[6px] mb-10 md-max:w-full mx-auto gap-6 px-6 md-max:px-[16px] font-noto">
        <div class="menu text-[11px] mt-10 flex gap-3 text-black/50 py-6">
            ...
            <NuxtLink to="/all-products/graphics/vector" class="text-black hover:text-[#005B52]">Vector</NuxtLink>
        </div>
        ...
        <div class="flex gap-6 py-6">
          <div class="w-[50%]">
            ...
            <h1 class="font-[700] heading text-[22px] sm:text-[26px]">
                Bring Fun and Personality to Your Designs with Vector Cartoons
            </h1>

            <p class="text-[15px] my-3 font-light">
            The Cartoons category in our Vector section is filled with playful, character-driven elements that add charm and energy to any design. These high-quality vector components include expressive characters, comic-style scenes, humorous icons, and storytelling visuals—all crafted to spark emotion and engagement.
            </p>

            <p class="text-[15px] my-3 font-light mt-10">
            Perfect for children’s content, educational materials, branding, digital storytelling, and lighthearted campaigns, each cartoon asset is fully editable and scalable, provided in formats like AI, SVG, and EPS. You can easily tweak colors, modify poses, or mix elements to match your creative direction.
            </p>


            <p class="text-[15px] font-light">
              Explore the collection and add a bold, whimsical touch to your next project with cartoon-style vectors that stand out.
            </p>

          </div>
          
          <div class="w-[50%]">
            <img src="/images/graphics/vectors/img.png" alt="thortok" />
          </div>
        </div>
    </div>
