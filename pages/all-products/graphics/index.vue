<template>
        ...
        <HeaderBlockSearchHead 
            backgroundImage="/images/graphics/bg-graphic.png"
            :defaultValue="'2'"
            :options=[]
            overlayColor="linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%)"
            :popularSearch=popularSearch
        >
        <template #title>Explore Our <br /> Graphic Resources</template>
        <template #description>
          <div class="font-noto text-white text-[13px]">
            Discover a vast collection of graphic elements for all your creative projects.
          </div>
        </template>
        </HeaderBlockSearchHead>
        ...
        <!-- SECTION EXPLORE OUR GRAPHIC -->
         <div class="container mx-auto w-[1440px]">
            <div class="menu text-[11px] mt-10 flex gap-3 text-black/50 px-6 py-4">
                <NuxtLink to="/" class="hover:text-[#005B52]">Home</NuxtLink> / 
                <NuxtLink to="/all-products" class="hover:text-[#005B52]">All Products</NuxtLink> / 
                <NuxtLink to="/all-products/graphics" class="text-black hover:text-[#005B52]">Graphics</NuxtLink>

            </div>

            <ExploreOurGraphicCollection />

         </div>
        <!-- END SECTION EXPLORE OUR GRAPHIC -->
...
<script setup lang="ts">
    ...
    import ExploreOurGraphicCollection from '~/components/all-proCom/ExploreOurGraphicCollection.vue'    
    ...
    const popularSearch = ref([
      { link: '/', name: 'Popular Search 1' },
      { link: '/', name: 'Popular Search 2' },
      { link: '/', name: 'Popular Search 3' },
    ]);
